...
import 'package:notidy/home/Dashboard/quickactions/create_update_note_view.dart';
import '../../utils/dialogs/signout_dialog.dart';
            ...
            itemBuilder: (context) {
              return [
                PopupMenuItem<DashboardActions>(
                  onTap: () {
                    Navigator.pushNamed(
                        context, CreateUpdateNoteScreen.routeName);
                  },
